...
final RegExp phoneValidNumberRegExp = RegExp(r"^\d{10,}$");
const String kEmailNullError = "Please Enter your email";
const String kPhoneNullError = "Please Enter your phone number";
const String kPhoneValidNumberError = "Phone number must be number";
const String kPhoneValidError = "Phone number have to be at lease 10 characters";
